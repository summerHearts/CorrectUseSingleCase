...
- (void)viewDidLoad {
    ...
    [self.profileImage sd_setImageWithPreviousCachedImageWithURL:[NSURL URLWithString:@"https://avatars1.githubusercontent.com/u/10678821?v=3&s=460"] placeholderImage:[UIImage imageNamed:@""] options:SDWebImageProgressiveDownload progress:^(NSInteger receivedSize, NSInteger expectedSize) {
